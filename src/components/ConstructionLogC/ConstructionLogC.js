...
function ConstructionLogC() {
  ...
  const renderLogForm = () => {
    return (
      <form onSubmit={handleSubmitLog} className="add-log-form">
        ...
        >
          <h4 style={{ marginBottom: "15px", marginTop: 0 }}>验收与检验信息</h4>
        ...
        >
          <h4 style={{ marginBottom: "15px", marginTop: 0 }}>质量与安全信息</h4>
  ...
  const renderLogsList = () => {
    if (logs.length === 0 && !showAddForm && !showOfflineSigning) {
      return (
