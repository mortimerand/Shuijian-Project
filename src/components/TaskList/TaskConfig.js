...
const TASK_CONFIG = {
  ...
  fixedTasks: [
    ...
    },
    {
      ...
      title: "钢筋笼焊接技术交底",
      description: "向施工人员详细说明钢筋笼焊接的技术要求、质量标准和安全注意事项",
      additionalTemplates: [
        {
  ...
  taskDataMapping: {
    ...
    GANGJINLONG_GANGJIN_CUNCHU: {
      "钢筋笼钢筋存储原材料存储照片": "GANGJINLONG_GANGJIN_CUNCHU_YUANCAILIAO_CUNCHU_ZHAOPIAN",
      "钢筋笼钢筋存储存储场地照片": "GANGJINLONG_GANGJIN_CUNCHU_CUNCHU_CHANGDI_ZHAOPIAN",
    },
    GANGJINLONG_GANGJIN_JINCHANG: {
      "钢筋笼进场出场质量说明书": "GANGJINLONG_GANGJIN_JINCHANG_CHUCHANG_ZHILIANG_SHUOMINGSHU",
      "钢筋笼钢筋进场试验报告单": "GANGJINLONG_GANGJIN_JINCHANG_CESHI_BAOGAODAN",
      "钢筋笼进场原材料、试块、试件见证取样送检委托书": "GANGJINLONG_GANGJIN_JINCHANG_WEITUOSHU",
      "钢筋笼进场现场验收照片": "GANGJINLONG_GANGJIN_JINCHANG_XIANCHANG_YANSHOU_ZHAOPIAN",
      "钢筋笼进场现场建筑、安装原材料、设备及配件产品进场验收记录": "GANGJINLONG_GANGJIN_JINCHANG_YANSHOU_JILU",
    },
    GANGJINGLONG_HANJIE_JISHU: {
      "钢筋笼焊接技术交底照片": "GANGJINGLONG_HANJIE_JISHU_JIAODI_ZHAOPIAN",
      "钢筋笼焊接安全技术交底书": "GANGJINGLONG_HANJIE_JISHU_HANJIE_ANQUAN_JISHU_JIAODISHU",
    },
    GANGJINLONG_SHENGCHAN: {
      "钢筋笼生产作业照片": "GANGJINLONG_SHENGCHAN_ZUOYE_ZHAOPIAN",
      "钢筋笼生产检查照片": "GANGJINLONG_SHENGCHAN_JIANCHA_ZHAOPIAN",
      "钢筋笼生产钢筋焊接连接接头工艺检验见证取样送检委托书": "GANGJINLONG_SHENGCHAN_SONGJIAN_WEITUOSHU",
    ...
    GANGJINLONG_DIAOZHUANG: {
      ...
      "钢筋笼吊装灌注完成照片": "GANGJINLONG_DIAOZHUANG_GUANZHU_WANCHENG_ZHAOPIAN",
      "钢筋笼吊装混凝土浇灌令": "GANGJINLONG_DIAOZHUANG_JIAOGUANLING",
      "钢筋笼吊装人工挖孔灌注桩单桩施工记录": "GANGJINLONG_DIAOZHUANG_GUANZHU_CHENGZHUANG_JILU",
    },
  },
